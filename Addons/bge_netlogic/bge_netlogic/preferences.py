...
_uplogic_versions = [
    ...
    ('5.1.1b', '5.1.1b', 'Suitable for Logic Nodes 5.1.1')
]
...
class LogicNodesAddonPreferences(bpy.types.AddonPreferences):
    ...
    use_symlink: bpy.props.BoolProperty(name='As Symlink', default=False, description='Engine will not actually be copied, but a symlink will be created to have the engine available from the project path')
    ...
    uplogic_version: bpy.props.EnumProperty(items=_uplogic_versions, default='5.1.1b', name='Uplogic Version')
